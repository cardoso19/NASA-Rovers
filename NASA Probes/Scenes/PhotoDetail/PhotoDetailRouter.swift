...
class PhotoDetailRouter: NSObject, PhotoDetailRoutingLogic, PhotoDetailDataPassing {
    ...
    //func navigateToSomewhere(source: PhotoDetailViewController, destination: SomewhereViewController)
    //{
    ...
    //func passDataToSomewhere(source: PhotoDetailDataStore, destination: inout SomewhereDataStore)
    //{
